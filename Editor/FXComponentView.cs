...
namespace PSkrzypa.UnityFX.V2.Editor
{
    public class FXComponentView : VisualElement
    {
        ...
        public FXComponentView()
        {
            ...
            progressBar.schedule.Execute(() => progress.style.display = progressBar.value > progressBar.lowValue ? DisplayStyle.Flex : DisplayStyle.None).Every(30);
